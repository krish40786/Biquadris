...
L_Block::L_Block(int level_generated, int weight) 
	: Block{level_generated, weight} {
	squares->emplace_back(new Square{0, 3, 'L'});
	squares->emplace_back(new Square{1, 3, 'L'});
	squares->emplace_back(new Square{2, 3, 'L'});
	squares->emplace_back(new Square{2, 2, 'L'});
}
...
void L_Block::clockwise(Board *b, int num_spins) {
...
void L_Block::counterclockwise(Board *b, int num_spins) {
	int x0 = squares->at(0)->getX();
	int y0 = squares->at(0)->getY();
	int x1 = squares->at(1)->getX();
	int y1 = squares->at(1)->getY();
...
void L_Block::printBlock(int currplayer) {
	string space = " ";
    cout << space * currplayer * 16 << "  L" << endl;
    cout << space * currplayer * 16 << "LLL" << endl;
}
