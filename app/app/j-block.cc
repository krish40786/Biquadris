...
J_Block::J_Block(int level_generated, int weight) 
	: Block{level_generated, weight} {
	squares->emplace_back(new Square{0, 2, 'J'});
	squares->emplace_back(new Square{0, 3, 'J'});
	squares->emplace_back(new Square{1, 3, 'J'});
	squares->emplace_back(new Square{2, 3, 'J'});
}
...
void J_Block::clockwise(Board *b, int num_spins) {
...
void J_Block::counterclockwise(Board *b, int num_spins) {
	int x0 = squares->at(0)->getX();
	int y0 = squares->at(0)->getY();
	int x1 = squares->at(1)->getX();
	int y1 = squares->at(1)->getY();
...
void J_Block::printBlock(int currplayer) {
	string space = " ";
    cout << space * currplayer * 16 << "J" << endl;
    cout << space * currplayer * 16 << "JJJ" << endl;
}